...
const reviews = [
  {
    ...
    rating: 5,
    text:
      "A fost super fain! Cabana chiar a fost mai frumoasă decăt mă așteptam. O să revenim cu siguranță.",
    date: "January 2024",
  },
  {
    name: "Mihaela R.",
    rating: 5,
    text:
      "Locul perfect pentru un weekend. Priveliștea este wow, nici nu am vrut să plecăm de acolo!",
    date: "February 2024",
  },
  {
    name: "Emilia L.",
    rating: 5,
    text:
      "Mi-a plăcut foarte mult aici, cabana este foarte primitoare și curată. Cu siguranță o să mai venim!",
    date: "March 2024",
  },
  {
    name: "Adrian S.",
    rating: 5,
    text:
      "A fost minunat! Totul a fost perfect, iar cabana are tot ce îți trebuie. Sper să revenim curând!",
    date: "March 2024",
  },
  {
    name: "Lazar M.",
    rating: 5,
    text:
      "O vacanță de neuitat! Cabana e super confortabilă și avem amintiri frumoase de aici.",
    date: "March 2024",
  },
  {
    name: "Maria",
    rating: 5,
    text:
      "Personalul foarte serviabil,mâncarea tradițională bună,peisajul f frumos.",
    date: "March 2024",
  },
];
